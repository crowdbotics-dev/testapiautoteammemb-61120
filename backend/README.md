...
## Project Structure
    ...
    ├── testapiautoteammemb_61120  # Django project configurations
...
1. Clone this repo and `cd testapiautoteammemb_61120`
...
2. Clone this repo and `cd testapiautoteammemb_61120`
